...
<template>
  <a class="skip-link" :href="projectVisible ? '#project-main-content' : '#main-content'">
    {{ t("skip-to-content") }}
  </a>
  <Header />

  <!-- main page -->
  <main id="main-content" tabindex="-1" :class="{ 'home-wrapper-projectIsReady': projectVisible }">
    <Home />
  </main>
  ...
  >
    <main id="project-main-content" class="project-content" tabindex="-1">
      <Project />
    </main>
  </div>
