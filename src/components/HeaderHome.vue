...
type ActiveLink = "about" | "projects" | "experience" | "skills" | "education" | "contact";
const activeLink = ref<ActiveLink | null>(null);
const sections: ActiveLink[] = ["about", "projects", "experience", "skills", "education", "contact"];
const content = usePortfolioContent();
const ariaLabels = computed(() => content.value.nav);
...
<template>
  <nav
    :class="['header-home', { 'header-home-mounted': isMounted, 'header-home-isProjectPage': projectId !== null }]"
  ...
  >
    <div :class="['header-home-links', { 'header-home-links-dark': isDarkTheme }]">
      ...
      <HeaderLink
        ...
        :aria-current="activeLink === section && hasScrolledIntoView ? 'true' : undefined"
        data-sound="click"
