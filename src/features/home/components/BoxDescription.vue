...
<template>
  <ProjectedElement :point="point">
    <article ref="wrapperRef" class="box-description" :aria-label="content.about.label">
      <div class="box-description-content">
        <div class="box-description-details">
          <p class="box-description-details-name">{{ content.profile.initials }}</p>
        ...
        <div class="box-description-copy">
          <p class="box-description-label">{{ content.about.label }}</p>
          <AppearingText
            :text="content.about.tagline"
            :steps="3"
            :duration="0.7"
            @timeline:created="(tl: gsap.core.Timeline) => handleTimelineCreated(tl, 0)"
          />
          <ul class="box-description-steps" :aria-label="content.about.terminal.approachLabel">
            <li v-for="step in content.about.terminal.approach" :key="step">{{ step }}</li>
          </ul>
        </div>
      </div>
    </article>
